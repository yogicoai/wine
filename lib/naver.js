...
//
// 확인은 못 했다. 네이버가 서버에서 오는 요청을 전부 418 로 막는데, 번호가
// 맞든 catalog/1 같은 엉터리든 똑같이 418 이라 유효성을 가릴 수가 없다.
// 그래서 이 링크는 검색 링크를 대신하지 않고 그 옆에 함께 둔다 — 번호가
// 틀려 페이지가 안 열려도 검색으로 가는 길이 그대로 남아 있어야 한다.
//
