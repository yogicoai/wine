...
export function ftpConfigured() {
  return !!(process.env.YOGIBO_FTP && process.env.YOGIBO_FTP_ID && process.env.YOGIBO_FTP_PW);
}

// 원격 디렉터리 (예: /app/img/wine/)
function remoteDir() {
  const dir = process.env.YOGIBO_FPT_LINK || "/app/img/wine/";
