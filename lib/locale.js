...
// 첫 칸은 "번역하지 않은 원문"이다. 그 원문이 무슨 말인지는 앱마다 다르다 —
// 전통술 앱의 술 정보는 처음부터 영어로 쓰여 있어(외국인 대상), 거기서 "한국어"라고
// 적어 놓고 영어를 보여 주면 거짓말이 된다.
const NATIVE = APP.locale === "en"
  ? { key: "en", label: "English" }
  : { key: "ko", label: "한국어" };

export const LOCALES = [
  NATIVE,
  ...(NATIVE.key === "en" ? [] : [{ key: "en", label: "English" }]),
  { key: "ja", label: "日本語" },
];
