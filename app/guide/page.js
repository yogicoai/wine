        ...
        <div className={s.body}>
          ...
          <div className={s.screens}>
            ...
            <div className={s.screen}>
              ...
              <ul className={s.list}>
                <li><b>제품 정보</b> — 이름 · 생산자 · 빈티지 · 지역 · 도수, 인식 신뢰도. 목록마다 <b>국기</b>로 산지를 표시합니다</li>
                ...
                <li>
                  <b>마시기 전 준비</b> — 술마다 다르게 계산합니다. 스파클링에는 디캔팅을 권하지 않고
                  (기포가 날아갑니다), 오래된 와인은 짧게, 탄닌이 강한 와인은 길게. 여러 병을 동시에
                  준비해도 각각 따로 셉니다
                </li>
            ...
            <div className={s.screen}>
              ...
              <ul className={s.list}>
                ...
                <li>
                  <b>가격 이력</b> — 매일 확인한 최저가를 <b>6개월치</b> 그래프로. 지금 값이 6개월
                  최저·최고 대비 어디쯤인지 함께 보여 주고, 목표가 후보도 그 값에서 제안합니다
                </li>
            ...
            <div className={s.screen}>
              ...
              <p className={s.p} style={{ marginTop: "0.9rem" }}>
                메뉴판 표기는 우리 표기와 늘 조금씩 다릅니다. “샤토 탈보”와 “샤또 딸보”,
                “카사 산토스 리마 델 빈도”와 “카사 산토스 리마”처럼요. 글자가 정확히 같지 않아도
                <b> 겹치는 낱말로 이어서 찾습니다.</b> 다른 표기로 이었을 때는 화면에 밝힙니다.
              </p>
            </div>

            <div className={s.screen}>
              <span className={s.tag}>Screen 7</span>
              <h3 className={s.h4}>내 정보</h3>
              <p className={s.p}>헤더의 사람 아이콘에서 열립니다.</p>
              <ul className={s.list}>
                <li>
                  <b>진행 중인 준비</b> — 칠링 · 디캔팅이 몇 분 남았는지. 술 이름을 누르면 그 술로
                  이동합니다. 화면 구석의 떠 있는 버튼에서도 바로 보입니다
                </li>
        ...
        <div className={s.body}>
          ...
          <div className={s.edge}>
            ...
            <p className={s.p} style={{ marginTop: "0.7rem" }}>
              데이터가 늘어나는 길이 셋입니다. <b>매일 새벽</b> 판매처 인기 상품을 자동으로 수확하고,
            ...
            <table className={s.table}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>국내 최저가 + 6개월 이력 보유 (해외 시세는 없음)</td>
                </tr>
                <tr>
                  <td>CellarTracker</td>
          ...
          <p className={s.p} style={{ marginTop: "1rem" }}>
            ...
            술 단위로 집계해 두었습니다. 다만 <b>사람당 한 표</b>가 성립하려면 로그인이 먼저입니다.
          </p>

          <h3 className={s.h4} style={{ marginTop: "2rem" }}>아직 없는 것</h3>
          <p className={s.p}>
            숨길 이유가 없어 적어 둡니다. 없는 것을 적지 않으면 있는 것처럼 읽힙니다.
          </p>
          <ul className={s.list}>
            <li><b>집단 평점의 규모</b> — 구조는 갖췄으나 표가 아직 쌓이지 않았습니다. 시간으로만 해결됩니다</li>
            <li><b>소셜 팔로우 피드</b> — 소믈리에 · 친구를 따라보는 흐름. 사용자 수가 받쳐줘야 의미가 있습니다</li>
            <li><b>오프라인 매장 재고 · 픽업</b> — 국내 구매 전환의 핵심이지만 매장 제휴가 선행되어야 합니다</li>
            <li><b>해외 시세</b> — 국내 최저가만 봅니다. 별도 데이터원이 필요합니다</li>
            <li><b>음식 사진 → 와인 역추천</b>, <b>다국어 라벨</b>, <b>오프라인 사용</b> — 미구현</li>
            <li><b>로그인 · 만 19세 인증</b> — 진행 예정. 스토어 출시와 구독의 공통 선행 조건입니다</li>
          </ul>
        </div>
      </section>
          ...
          <div className={s.scroll}>
            <table className={s.table}>
              ...
              <tbody>
                ...
                <tr>
                  <td>맛 프로필</td>
                  <td className={s.was}>수확으로 들어온 술은 품종에서 짐작한 값</td>
                  <td className={s.now}>화면에 짐작임을 밝히고, 라벨을 찍으면 실제 분석으로 대체</td>
                </tr>
                <tr>
                  <td>기록 저장</td>
                  <td className={s.was}>로그인 전이라 기기 단위로 저장</td>
                  <td className={s.now}>로그인 도입 시 계정으로 이전</td>
                </tr>
                <tr>
                  <td>연결이 끊기면</td>
                  <td className={s.was}>분석 · 검색 · 가격 조회 모두 서버를 거침</td>
                  <td className={s.now}>끊김을 화면에 알리고, 원인을 짚는 문구로 안내</td>
                </tr>
              </tbody>
            </table>
          </div>
